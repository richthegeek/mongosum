...
(function() {
  ...
  ({
    get_schema: function(object) {
      return this.walk_objects(object, {}, function(key, vals, types) {
        var ret;
        ret = {};
        ret.type = types[0];
        ret.example = vals[0];
    ...
    merge_schema: function(left, right) {
      return this.walk_objects(left, right, function(key, vals, types) {
        if (!vals[0] && vals[1]) {
          vals[0] = vals[1];
        }
    ...
    walk_objects: function(object, second, fn) {
      ...
      for (_i = 0, _len = keys.length; _i < _len; _i++) {
        ...
        if ((type1 === 'Object' || type1 === 'Array') && !(v1.type != null)) {
          object[key] = this.walk_objects(v1, v2, fn);
        } else {
